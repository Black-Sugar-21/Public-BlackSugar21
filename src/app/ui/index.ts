// Atomic Design barrel — import primitives from '@app/ui' (or relative './ui').
// atoms → molecules → organisms → templates → pages.
export { UiButtonComponent } from './atoms/ui-button.component';
export { UiPillComponent } from './atoms/ui-pill.component';
