...
const SHELL_I18N: Record<string, Record<string, string>> = {
  ...
  daConfirmDesc: {"es":"Antes de irte, considera lo que perderás. Esta acción es permanente y no se puede deshacer.","en":"Before you go, please consider what you'll lose. This action is permanent and cannot be undone.","pt":"Antes de sair, considere o que vai perder. Esta ação é permanente e não pode ser desfeita.","fr":"Avant de partir, pense à ce que tu perdras. Cette action est permanente et irréversible.","de":"Bevor du gehst, bedenke, was du verlierst. Diese Aktion ist endgültig und kann nicht rückgängig gemacht werden.","it":"Prima di andare, considera cosa perderai. Questa azione è permanente e non può essere annullata.","zh":"在离开之前，请考虑你将失去什么。此操作是永久性的，无法撤销。","ja":"退会する前に、失うものをご確認ください。この操作は永久的で取り消せません。","ko":"떠나기 전에 잃게 될 것을 생각해 보세요. 이 작업은 영구적이며 되돌릴 수 없어요.","ru":"Прежде чем уйти, подумайте, что вы потеряете. Это действие необратимо.","ar":"قبل أن تغادر، فكّر فيما ستفقده. هذا الإجراء دائم ولا يمكن التراجع عنه.","id":"Sebelum pergi, pertimbangkan apa yang akan hilang. Tindakan ini permanen dan tidak dapat dibatalkan.","tr":"Gitmeden önce neleri kaybedeceğini düşün. Bu işlem kalıcıdır ve geri alınamaz."},
