...
const LOGIN_I18N: Record<string, Record<string, string>> = {
  ...
  trust: {"es":"Gratis · 10 segundos · sin tarjeta","en":"Free · 10 seconds · no card","pt":"Grátis · 10 segundos · sem cartão","fr":"Gratuit · 10 secondes · sans carte","de":"Kostenlos · 10 Sekunden · keine Karte","it":"Gratis · 10 secondi · senza carta","zh":"免费 · 10 秒 · 无需银行卡","ja":"無料 · 10秒 · カード不要","ko":"무료 · 10초 · 카드 불필요","ru":"Бесплатно · 10 секунд · без карты","ar":"مجاني · 10 ثوانٍ · بدون بطاقة","id":"Gratis · 10 detik · tanpa kartu","tr":"Ücretsiz · 10 saniye · kart yok"},
