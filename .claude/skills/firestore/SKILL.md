...
```
learningProfile: {interactionCount, positiveEngagementCount, topTopics, recentTopics, preferredStyle, lastUpdated}
```
...
## CF Count Total: 46 callable + 11 scheduled + 7 triggers + 1 alias
