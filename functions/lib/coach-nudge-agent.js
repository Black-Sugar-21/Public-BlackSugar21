...
const NUDGE_TITLE = {
  ...
  it: '✨ Prova il tuo prossimo messaggio',
  ja: '✨ 次のメッセージを練習',
  ko: '✨ 다음 메시지를 연습하세요',
  zh: '✨ 演练你的下一条消息',
...
const NUDGE_BODY = {
  ...
  it: '{name} non ha ancora risposto. Vuoi provare un messaggio con il Coach IA?',
  ja: '{name}さんからまだ返信がありません。AIコーチで次のメッセージを練習しませんか？',
  ko: '{name}님이 아직 답장하지 않았어요. AI 코치와 다음 메시지를 연습해볼까요?',
